...
Coloca los archivos iniciar_entorno.bat y setup.sql en la misma carpeta.

Asegúrate de que Docker Desktop esté corriendo.

Haz doble clic en iniciar_entorno.bat.
...
<details> <summary>Ver lo que hace el script .bat (Opcional)</summary>
...
Importa el archivo workflow.json (puedes arrastrarlo y soltarlo en el canvas).

Configurar Credenciales: El flujo no funcionará hasta que configures las "llaves" de la base de datos.
...
Activa el flujo (Switch "Active" en verde en la esquina superior derecha).

3. Ejecutar el Cliente Web
Abre el archivo index.html.

Edita la línea const WEBHOOK_URL = '...' y asegúrate de pegar tu URL de Producción de n8n (la obtienes del nodo Webhook).
